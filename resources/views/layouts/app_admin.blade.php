...
<head>
  ...
  <body>
    ...
    <script src="{{ asset('admin_assets/lib/datatables/js/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('admin_assets/lib/datatables-bs4/dataTables.bootstrap4.min.js') }}"></script>
    <script src="{{ asset('admin_assets/lib/datatables.net-responsive/dataTables.responsive.js') }}"></script>
    <script src="{{ asset('admin_assets/lib/datatables.net-responsive-bs4/responsive.bootstrap4.js') }}"></script>
