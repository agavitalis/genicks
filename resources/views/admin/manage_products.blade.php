            ...
            <table class="table table-sm mb-0 table-striped table-dashboard fs--1 data-table border-bottom border-200"
                ...
                <thead class="bg-200 text-900">
                    <tr>
                        ...
                        <th class="align-middle sort">Product Name</th>
                        <th class="align-middle sort pr-7">Date Uploaded</th>
                        <th class="align-middle sort" style="min-width: 12.5rem;">Product Picture</th>
                    ...
                    @foreach($products as $product)
                        <tr class="btn-reveal-trigger">
                            ...
                            <td class="py-2 align-middle white-space-nowrap"><a href="order-details.html">
                                    <strong>#{{$count}}</strong></a><strong>{{$product->product_name}}</strong></td>
                            <td class="py-2 align-middle">{{$product->created_at->diffForHumans()}}</td>
                            <td class="py-2 align-middle  fs-0 font-weight-medium"><img src="{{$product->picture_url}}" height="25px" width="25px" ></td>
                           
                            <td class="py-2 align-middle text-center fs-0 white-space-nowrap"><span
                                    class="badge badge rounded-capsule d-block badge-soft-success">{{$product->status}}<span
