...
<div class="card bg-light mb-3">
    <div class="card-body p-3">
        <p class="fs--1 mb-0"><a href="#!"><span class="fas fa-exchange-alt mr-2" data-fa-transform="rotate-90"></span>This 
    ...
    <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
        ...
        <div class="card-body position-relative">
            ...
            <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif text-info"
                ...
                class="font-weight-semi-bold fs--1 text-nowrap" href="#!">Requests<span
    ...
    <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
        ...
        <div class="card-body position-relative">
            ...
            <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif"
                ...
                class="font-weight-semi-bold fs--1 text-nowrap" href="#!">Contacts<span
                    class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
        </div>
    </div>
</div>
