                        ...
                        <div class="col-sm-7 col-md-8">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <a class="btn btn-sm btn-info float-right mt-1" href="#!">
                                            <span class="fas fa-eye"> </span><span class="ml-2 d-md-inline-block">Details</span>
                                    </a>
                                </div>
                                <div class="col-lg-4 d-flex justify-content-between flex-column">
                                    <div>
                                        <h4 class="fs--1 fs-md-2 text-warning mb-0">Ogbonna Vitalis</h4>
                                        <h5 class="fs--1 text-500 mb-0 mt-1">20th May 2019</h5>

                                        <div class="d-none d-lg-block">
                                            <p class="fs--1 mb-1">Likes: <strong>50</strong></p>
